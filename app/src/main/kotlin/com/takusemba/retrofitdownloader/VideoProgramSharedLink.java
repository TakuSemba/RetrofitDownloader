...
// Source file: api/video.proto at 149:1
 ...
 * ビデオ番組の共有リンク
 */
public final class VideoProgramSharedLink extends Message<VideoProgramSharedLink, VideoProgramSharedLink.Builder> {
  ...
  public VideoProgramSharedLink(String twitter, String facebook, String google, String line, String copy) {
    this(twitter, facebook, google, line, copy, ByteString.EMPTY);
  }

  public VideoProgramSharedLink(String twitter, String facebook, String google, String line, String copy, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof VideoProgramSharedLink)) return false;
    VideoProgramSharedLink o = (VideoProgramSharedLink) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "VideoProgramSharedLink{").append('}').toString();
  }
  ...
  public static final class Builder extends Message.Builder<VideoProgramSharedLink, Builder> {
    ...
    public VideoProgramSharedLink build() {
      return new VideoProgramSharedLink(twitter, facebook, google, line, copy, buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_VideoProgramSharedLink extends ProtoAdapter<VideoProgramSharedLink> {
    ...
    @Override
    public int encodedSize(VideoProgramSharedLink value) {
    ...
    @Override
    public void encode(ProtoWriter writer, VideoProgramSharedLink value) throws IOException {
    ...
    @Override
    public VideoProgramSharedLink decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public VideoProgramSharedLink redact(VideoProgramSharedLink value) {
