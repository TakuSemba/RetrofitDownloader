...
// Source file: api/share.proto at 48:1
...
/**
 * / Represents a response of sharing the broadcast slot
 */
public final class SlotShareResponse extends Message<SlotShareResponse, SlotShareResponse.Builder> {
  public static final ProtoAdapter<SlotShareResponse> ADAPTER = new ProtoAdapter_SlotShareResponse();
  ...
  public SlotShareResponse(String id, TwitterUser twitter, String status, Long createdAt) {
    this(id, twitter, status, createdAt, ByteString.EMPTY);
  }

  public SlotShareResponse(String id, TwitterUser twitter, String status, Long createdAt, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof SlotShareResponse)) return false;
    SlotShareResponse o = (SlotShareResponse) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "SlotShareResponse{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<SlotShareResponse, Builder> {
    public String id;
    ...
    @Override
    public SlotShareResponse build() {
      return new SlotShareResponse(id, twitter, status, createdAt, buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_SlotShareResponse extends ProtoAdapter<SlotShareResponse> {
    ProtoAdapter_SlotShareResponse() {
      super(FieldEncoding.LENGTH_DELIMITED, SlotShareResponse.class);
    }

    @Override
    public int encodedSize(SlotShareResponse value) {
    ...
    @Override
    public void encode(ProtoWriter writer, SlotShareResponse value) throws IOException {
    ...
    @Override
    public SlotShareResponse decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public SlotShareResponse redact(SlotShareResponse value) {
