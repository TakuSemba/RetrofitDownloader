...
// Source file: api/user.proto at 234:1
...
public final class SaveDeviceNotificationSettingResponse extends Message<SaveDeviceNotificationSettingResponse, SaveDeviceNotificationSettingResponse.Builder> {
  ...
  public SaveDeviceNotificationSettingResponse(Boolean recommendation) {
    this(recommendation, ByteString.EMPTY);
  }

  public SaveDeviceNotificationSettingResponse(Boolean recommendation, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof SaveDeviceNotificationSettingResponse)) return false;
    SaveDeviceNotificationSettingResponse o = (SaveDeviceNotificationSettingResponse) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "SaveDeviceNotificationSettingResponse{").append('}').toString();
  }
  ...
  public static final class Builder extends Message.Builder<SaveDeviceNotificationSettingResponse, Builder> {
    ...
    public SaveDeviceNotificationSettingResponse build() {
      return new SaveDeviceNotificationSettingResponse(recommendation, buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_SaveDeviceNotificationSettingResponse extends ProtoAdapter<SaveDeviceNotificationSettingResponse> {
    ...
    @Override
    public int encodedSize(SaveDeviceNotificationSettingResponse value) {
      return (value.recommendation != null ? ProtoAdapter.BOOL.encodedSizeWithTag(1, value.recommendation) : 0)
          + value.unknownFields().size();
    }

    @Override
    public void encode(ProtoWriter writer, SaveDeviceNotificationSettingResponse value) throws IOException {
      if (value.recommendation != null) ProtoAdapter.BOOL.encodeWithTag(writer, 1, value.recommendation);
      writer.writeBytes(value.unknownFields());
    }

    @Override
    public SaveDeviceNotificationSettingResponse decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public SaveDeviceNotificationSettingResponse redact(SaveDeviceNotificationSettingResponse value) {
