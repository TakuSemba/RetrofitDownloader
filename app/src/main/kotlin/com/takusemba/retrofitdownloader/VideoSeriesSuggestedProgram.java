...
// Source file: api/video.proto at 131:1
 ...
 * ビデオシリーズにおける提案枠プログラム
 */
public final class VideoSeriesSuggestedProgram extends Message<VideoSeriesSuggestedProgram, VideoSeriesSuggestedProgram.Builder> {
  public static final ProtoAdapter<VideoSeriesSuggestedProgram> ADAPTER = new ProtoAdapter_VideoSeriesSuggestedProgram();
  ...
  public VideoSeriesSuggestedProgram(String id, Long duration, String thumbImage, List<String> sceneThumbImages, Long imageUpdatedAt, String title, Long position, Long endAt, Long freeEndAt) {
    this(id, duration, thumbImage, sceneThumbImages, imageUpdatedAt, title, position, endAt, freeEndAt, ByteString.EMPTY);
  }

  public VideoSeriesSuggestedProgram(String id, Long duration, String thumbImage, List<String> sceneThumbImages, Long imageUpdatedAt, String title, Long position, Long endAt, Long freeEndAt, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof VideoSeriesSuggestedProgram)) return false;
    VideoSeriesSuggestedProgram o = (VideoSeriesSuggestedProgram) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "VideoSeriesSuggestedProgram{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<VideoSeriesSuggestedProgram, Builder> {
    public String id;
    ...
    @Override
    public VideoSeriesSuggestedProgram build() {
      return new VideoSeriesSuggestedProgram(id, duration, thumbImage, sceneThumbImages, imageUpdatedAt, title, position, endAt, freeEndAt, buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_VideoSeriesSuggestedProgram extends ProtoAdapter<VideoSeriesSuggestedProgram> {
    ProtoAdapter_VideoSeriesSuggestedProgram() {
      super(FieldEncoding.LENGTH_DELIMITED, VideoSeriesSuggestedProgram.class);
    }
    ...
    public int encodedSize(VideoSeriesSuggestedProgram value) {
      return (value.id != null ? ProtoAdapter.STRING.encodedSizeWithTag(1, value.id) : 0)
          ...
          + (value.position != null ? ProtoAdapter.INT64.encodedSizeWithTag(7, value.position) : 0)
    ...
    @Override
    public void encode(ProtoWriter writer, VideoSeriesSuggestedProgram value) throws IOException {
      ...
      if (value.position != null) ProtoAdapter.INT64.encodeWithTag(writer, 7, value.position);
    ...
    @Override
    public VideoSeriesSuggestedProgram decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 7: builder.position(ProtoAdapter.INT64.decode(reader)); break;
